...
const TripleBox = ({
  ...
  const adjustTextSize = (boxRef, textBox, setFontSize) => {
    ...
    while (
      ...
      newFontSizeValue >
        (isBottomBox ? bottomBoxMinimumFontSize : minimumFontSize)
    ) {
      newFontSizeValue -= 1;
  ...
  return (
    ...
    >
      ...
      <div className={styles.topButtomBox}>
        ...
        >
          {textBoxes[auxIndex].text.bottom &&
            textBoxes[auxIndex].text.bottom.split(".")[1]?.split(" ")[0]}
        </div>
        <div
        ...
        >
          {textBoxes[auxIndex].text.bottom &&
          textBoxes[auxIndex].text.bottom.includes(" ")
